        ...
        <>
            ...
            <div className='container'>
                <div className="home-container">
                    ...
                    <img data-testid="home-pic" src="https://assets.ccbp.in/frontend/react-js/nxt-trendz-home-img.png" alt="clothes that get you noticed" className="home-desktop-img" />
                </div>
            </div>
        </>
    )
